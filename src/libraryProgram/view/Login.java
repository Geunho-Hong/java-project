...
public class Login extends JFrame {
	...
	private void initialize() {
		...
		lblNewLabel_1.setFont(new Font("�޸ո���T", Font.PLAIN, 23));
		lblNewLabel_1.setBounds(149, 33, 132, 50);
		Panel.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("ID:");
		lblNewLabel_2.setFont(new Font("�޸ո���T", Font.PLAIN, 23));
		lblNewLabel_2.setBounds(50, 132, 63, 44);
		Panel.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("PW:");
		lblNewLabel_3.setFont(new Font("�޸ո���T", Font.PLAIN, 23));
		...
		login.setFont(new Font("�޸ո���T", Font.PLAIN, 12));
		...
		signUp.setFont(new Font("�޸ո���T", Font.PLAIN, 12));
