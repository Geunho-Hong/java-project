...
public class PayDialog extends JDialog {
	...
	public PayDialog() {
		...
		JButton btn60 = new JButton("60��  1000��");
		...
		JButton btn120 = new JButton("120��  1800��");
		...
		JButton btn180 = new JButton("180�� 2500��");
		...
		JButton btn240 = new JButton("240��  3300��");
		...
		JButton btn300 = new JButton("300��  4200��");
	...
	private void btnClicked(JButton btn) {
		...
		System.out.println(costHour +"��(�ð�)�� �����Ǿ����ϴ�.");
	}	
