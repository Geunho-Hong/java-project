...
public class SignUp extends JFrame {
	...
	private void initialize() {
		...
		label_1.setFont(new Font("�޸ո���T", Font.PLAIN, 24));
		label_1.setBounds(152, 21, 139, 37);
		contentPane.add(label_1);
		
		JLabel label_2 = new JLabel("ID:");
		label_2.setFont(new Font("�޸ո���T", Font.PLAIN, 23));
	...
	public void insertUser() {
		...
		if (id.equals("")) {
			...
			if (result > 0) {
				JOptionPane.showMessageDialog(null, "ȸ�� ���� Success");
				setVisible(false);
			} else {
				JOptionPane.showMessageDialog(null, "ȸ�� ���� Fail");
			}			
		}
