...
public class UserInfo extends JFrame {
	...
	private void initialize() {
		...
		info.setFont(new Font("�޸ո���T", Font.PLAIN, 24));
		...
		lblId.setFont(new Font("�޸ո���T", Font.PLAIN, 23));
		...
		userPw.setFont(new Font("�޸ո���T", Font.PLAIN, 15));
		...
		userName.setFont(new Font("�޸ո���T", Font.PLAIN, 15));
		...
		userTel.setFont(new Font("�޸ո���T", Font.PLAIN, 15));
		...
		userHour.setFont(new Font("�޸ո���T", Font.PLAIN, 15));
